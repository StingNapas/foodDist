	...
	// Forms POST
			...
			function postData(form){
				form.addEventListener("submit", (e) => {
					...
					statusMessage.textContent = textMessage.loading;
					...
					request.addEventListener("load", () => {
						if(request.status === 200){
							...
							statusMessage.textContent = textMessage.ok;
							form.reset();
							setTimeout(() => {
								statusMessage.remove();
							}, 2000);
						} else {
							statusMessage.textContent = textMessage.fail;
						}
					});
				});
			}
